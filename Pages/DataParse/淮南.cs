    ...
    private static void BatchSaveToDatabase(List<Dictionary<string, string>> dicryList, string destinationFilePath)
    {
        ...
        foreach (var dicry in dicryList)
        {
            var sql = new StringBuilder(
                "insert into zhika(SN,F0主控,F0维护1,F0维护2,F0维护3,F0锁卡,F0解锁,F0消费1,F0消费2,F0圈存1,F0圈存2,F0TAC1,F0TAC2,F0圈提,F0透支,F0ef05,F0ef15,F0ef16,F0ef17,F0ef1A_01,F0ef1A_02,F0ef1A_03,F0ef1A_04,F0ef1A_05,F0ef1A_06,F0ef1A_07,F0ef1A_08,F0ef1A_09,F0ef1A_0A,F0ef1A_0B,F0ef1A_0C,F0ef1A_0D,F0ef1A_0E,F0ef1A_0F,F0ef1A_10,F0ef1A_11,F0ef1A_12,F0ef19_01,F0ef19_02,F0ef19_03,F0ef19_04,F0ef19_05,F0ef19_06,F0ef19_07,F2主控,F2维护1,F2维护2,F2锁卡,F2解锁,F2消费1,F2消费2,F2圈存1,F2圈存2,F2TAC1,F2TAC2,F2圈提1,F2圈提2,F2透支,F2ef1A_01,F2ef1A_02,F2ef19_01,F2ef19_02,F2ef19_03,F2ef19_04,F2ef19_05,F2ef19_06,F2ef19_07)values('");
            sql.Append(dicry["卡号"]).Append("','")
                ...
                .Append(dicry["F0ef1A_01"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_02"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_03"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_04"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_05"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_06"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_07"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_08"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_09"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0A"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0B"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0C"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0D"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0E"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_0F"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_10"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_11"].Substring(0,60)).Append("','")
                .Append(dicry["F0ef1A_12"].Substring(0,60)).Append("','")
                ...
                .Append(dicry["F2ef1A_01"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef1A_02"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_01"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_02"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_03"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_04"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_05"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_06"].Substring(0,60)).Append("','")
                .Append(dicry["F2ef19_07"].Substring(0,60)).Append("')");
